...
| 06 | Polynomial swing-system model with a rational Lyapunov function obtained via optimisation | 4D | D. Han, A. El-Guindy and M. Althoff, "Power systems transient stability analysis via optimal rational Lyapunov functions," 2016 IEEE Power and Energy Society General Meeting (PESGM), Boston, MA, USA, 2016, pp. 1-5, doi: 10.1109/PESGM.2016.7741322. |
